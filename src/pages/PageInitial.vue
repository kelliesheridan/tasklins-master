          ...
          <div>
            <q-item>
              ...
              <q-item-section top side>
                <q-item-label v-if="hatched === false">All Tasklins start out as eggs. You can store as many eggs as you want to, but to meet the Tasklin inside, you're going to have to give it something to work on. Use the + button to <strong>add your first five tasks</strong>. These can be any things you need to complete, such as 'Go for a walk' or 'Finish Math Homework'. <strong>Once you've added all five tasks, the hatch button will appear!</strong></q-item-label>
