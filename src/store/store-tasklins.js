    ...
    userSettings.once("value", snapshot => {
      ...
      if (tasklinInfo) {
        let payload = {
          ...
          bodyshape2: tasklinInfo.bodyShape2,
          bodyTexture: tasklinInfo.bodyTexture,
          color: tasklinInfo.color,
          color2: tasklinInfo.color2,
          color3: tasklinInfo.color3,
          creation_date: moment(tasklinInfo.creation_date).format("YYYY-MM-DD"),
          earsOrHorns: tasklinInfo.earsOrHorns,
          eyebrowsOrTail: tasklinInfo.eyebrowsOrTail,
          ...
          pattern1: tasklinInfo.pattern1,
          pattern2: tasklinInfo.pattern2,
